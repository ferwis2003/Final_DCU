...
namespace Practica_FinalDCU
{
    public partial class Escuela : Form
    {
        ...
        {
            Conexion.Conectar();
            string insertar = "INSERT INTO ALUMNO (CODIGO,NOMBRE,APELLIDO,DIRECCION,CORREO) VALUES(@CODIGO,@NOMBRE,@APELLIDO,@DIRECCION,@CORREO)";
        ...
        {
            Conexion.Conectar();
            String actualizar = "UPDATE ALUMNO SET CODIGO=@CODIGO, NOMBRE=@NOMBRE, APELLIDO=@APELLIDO, DIRECCION=@DIRECCION, CORREO=@CORREO WHERE CODIGO=@CODIGO";
